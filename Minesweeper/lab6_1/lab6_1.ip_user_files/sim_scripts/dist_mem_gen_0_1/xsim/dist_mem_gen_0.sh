...
#
# Generated by Vivado on Fri Dec 13 11:44:10 -0600 2024
...
simulate()
{
  xsim  dist_mem_gen_0 -key {Behavioral:sim_1:Functional:dist_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_block.protoinst" -log simulate.log
}
