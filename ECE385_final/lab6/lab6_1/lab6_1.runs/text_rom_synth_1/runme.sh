...
HD_PWD='C:/Users/dant0/Desktop/lab_7_2/lab6/lab6_1/lab6_1.runs/text_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log text_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source text_rom.tcl
