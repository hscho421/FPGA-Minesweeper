...
#
# Generated by export_simulation on Fri Dec 13 07:10:59 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './title_rom.sh' script.

./title_rom.sh -reset_run
...
./title_rom.sh -noclean_files

For more information on the script, please type './title_rom.sh -help'.
